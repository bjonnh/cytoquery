...
interface SeparableBlurUniforms {
    [key: string]: IUniform<any>;
...
export class UnrealBloomPass extends Pass {
    ...
    private highPassUniforms: BloomUniforms;
     ...
     */
    constructor(resolution?: Vector2, strength: number = 1, radius?: number, threshold?: number) {
        ...
        this.highPassUniforms = UniformsUtils.clone(highPassShader.uniforms) as BloomUniforms;
